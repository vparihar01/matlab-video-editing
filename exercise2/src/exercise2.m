...
function exercise2(input_directory, output_directory, start_frame, end_frame)
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%     video = effect_add_text(video, {{'../text/scene_text1.png', 1, 3}, ...     
%                                    {'../text/scene_text1.png', 6, 3}});     % add text frames at position X1 in original input files, text is displayed for Y1 frames
%     

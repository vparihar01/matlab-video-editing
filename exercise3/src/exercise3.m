...
function exercise3(input_directory, output_directory, start_frame, end_frame)
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    % APPLY ALL FILTERS THAT ALTER THE FRAME NUMBER/ORDER (AUFGABE 2)  
...
% 
%             video = effect_scene_cut(video, 0.85, 8);                  % OPTIONAL
        end

        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        % APPLY SPECIAL EFFECTS (AUFGABE 2)
